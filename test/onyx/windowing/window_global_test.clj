(ns onyx.windowing.window-global-test
...
(defn update-atom! [event window trigger {:keys [window extent->bounds changelog refinement-entry] :as opts} state]
  (doall 
