...
(defrecord FixedWindow [id task type aggregation init window-key min-value
                        range slide timeout-gap session-key doc
                        window init-fn create-state-update super-agg-fn apply-state-update]
  IWindow
  (speculate-update [this extents segment]
    extents)
...
(defrecord SlidingWindow [id task type aggregation init window-key min-value 
                          range slide timeout-gap session-key doc
                          window init-fn create-state-update super-agg-fn apply-state-update]
  IWindow
  (speculate-update [this extents segment]
...
(defrecord GlobalWindow [id task type aggregation init window-key min-value 
                        range slide timeout-gap session-key doc
                        window init-fn create-state-update super-agg-fn apply-state-update]
  IWindow
  (speculate-update [this extents segment]
...
(defrecord SessionWindow [id task type aggregation init window-key min-value
                          range slide timeout-gap session-key doc
                          window init-fn create-state-update super-agg-fn apply-state-update]
  IWindow
  (speculate-update [this extents segment]
